...
public class GdbExtendedFinalLaunchSequence_7_4 extends FinalLaunchSequence_7_2 {

	private IGDBControl fControl;
	private DsfServicesTracker fTracker;

	public GdbExtendedFinalLaunchSequence_7_4(DsfSession session, Map<String, Object> attributes, RequestMonitorWithProgress rm) {
	...
	protected String[] getExecutionOrder(String group) {
		if (GROUP_TOP_LEVEL.equals(group)) {
			...
			orderList.add(orderList.indexOf("stepInitializeFinalLaunchSequence_7_2") + 1, "stepInitializeExtendedFinalLaunchSequence_7_4"); //$NON-NLS-1$ //$NON-NLS-2$

			// As the first operation to do, show the user the version of GDB
			orderList.add(orderList.indexOf("stepInitializeExtendedFinalLaunchSequence_7_4") + 1, "stepNotifyVersion"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	@Execute
	public void stepInitializeExtendedFinalLaunchSequence_7_4(RequestMonitor rm) {
	...
	@RollBack("stepInitializeExtendedFinalLaunchSequence_7_4")
	public void rollBackInitializeExtendedFinalLaunchSequence_7_4(RequestMonitor rm) {
	...
	@Execute
	public void stepCleanupExtendedFinalLaunchSequence_7_4(final RequestMonitor rm) {
		if (fTracker != null) fTracker.dispose();
		fTracker = null;
		rm.done();
	}
