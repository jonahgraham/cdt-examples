...
public class FileBrowserModelAdapter extends AbstractVMAdapter
{
    ...
    protected IVMProvider createViewModelProvider(IPresentationContext context) {
    	IVMProvider provider = null;
    	// TODO 2 VMAdapter: Depending on the context, return the
    	// correct view model provider
    	// HINT: As there is only one view for now this can be trivial
        return provider;
    }
