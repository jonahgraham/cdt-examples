...
import com.kichwacoders.cdt.dsf.tutorial.timers.AlarmService.AlarmDMContext;
    ...
    implements IElementLabelProvider
{
    ...
    protected void updateElementsInSessionThread(final IChildrenUpdate update) {
        ...
        if (alarmService == null || alarmDmc == null || timerDmc == null) {
            update.setStatus(new Status(IStatus.ERROR, TutorialPlugin.PLUGIN_ID, "Required elements not found in path"));
            update.done();
            return;
        }
	...
	public void update(ILabelUpdate[] updates) {
        for (ILabelUpdate update : updates) {
            ...
            update.setImageDescriptor(
                TutorialPlugin.getDefault().getImageRegistry().getDescriptor(
                    TutorialPlugin.IMG_ALARM_TRIGGERED), 
                0);
            update.done();
        }
    }
