...
import com.kichwacoders.cdt.dsf.tutorial.timers.TimersVMProvider.ViewLayout;
...
public class TimersView extends ViewPart {
	...
	private void makeActions() {
        ...
        fToggleLayoutAction.setImageDescriptor(TutorialPlugin.getDefault().getImageRegistry().getDescriptor(
            TutorialPlugin.IMG_LAYOUT_TOGGLE));
		...
		fAddTimerAction.setImageDescriptor(
		    getImage(TutorialPlugin.IMG_TIMER));
        ...
        fAddTriggerAction.setImageDescriptor(
            getImage(TutorialPlugin.IMG_ALARM));
		...
		fRemoveAction.setImageDescriptor( getImage(TutorialPlugin.IMG_REMOVE) );
	}

	private ImageDescriptor getImage(String key) {
        return TutorialPlugin.getDefault().getImageRegistry().getDescriptor(key);
	}
